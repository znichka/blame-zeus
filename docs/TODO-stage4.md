...
- [ ] **A1** `schema.py` — Pydantic models scoped to this project's actual schema (not the broader entity/claim/conflict/place/event shape considered and rejected in ADR-004):
  ```python
