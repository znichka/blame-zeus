...
- [x] **Stage P3b — DATA floor closure** (`docs/DATA-GAPS.md` GAP-002 + GAP-003) — Q6/Q7/Q8 stable-fail (DATA 2/5 vs a 50% floor); triaged to P3 in P1 but never listed there `[DEVIATED - see DEVIATIONS.md #DEV-093]`. **Landed 2026-07-27 (DEV-094, DEV-095): DATA 100% (5/5), overall 15/16 (94%), the project's best result to date.** GAP-003 fully resolved. GAP-002's broader 367-name backlog (Track D) remains open but was never gate-blocking.
